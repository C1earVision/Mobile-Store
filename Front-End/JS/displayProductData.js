...
//   handle image click
  ...
  ${(localStorage.getItem('admin') === 'true') || (used === 'true' && soldBy === `${localStorage.getItem('name')}`)? '<input onclick="deleteProduct(event)" type="button" id="delete-product" value="Delete Product" />':''}
